                    ...
                    with st.spinner("Calculating stresses..."):
                        ...
                        if results:
                            ...
                            with col2:
                                ...
                                fig_3d_surface, fig_3d_scatter = create_3d_visualization(
...
def create_3d_visualization(X, Y, Z, hoop_stress_fd, wellbore_radius, current_depth, current_azimuth, threshold_percent):
    ...
    fig_surface.update_layout(
        title=f'3D Wellbore Hoop Stress at {current_depth:.0f} ft<br>Azimuth: {current_azimuth:.1f}°',
        scene=dict(
            xaxis_title='X (ft)',
            yaxis_title='Y (ft)',
    ...
    return fig_surface, fig_scatter
...
def create_2d_plots(R, Theta, Depth, hoop_stress_fd, sigma_H_3d, sigma_h_3d, Pp_3d, 
    ...
    polar_fig.update_layout(
        ...
        title=f'2D Polar Stress Distribution at {current_depth:.0f} ft',
        height=500
    )
